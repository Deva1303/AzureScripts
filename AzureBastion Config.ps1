...
$rgBastion = "Dev_RG"
$rgNetworkSpoke = "Dev_RG"
$rgLogAnalyticsSpoke = "Dev_RG"

$vnetName = "VNET1"
$subnetNameBastion = "AzureBastionSubnet"
$subnetBastionAddress = "10.0.2.0/24"
$nsgNameBastion = "nsg-AzureBastionSubnet"

$bastionName = "bastionhost-hub-cit"
$bastionPipName = "pip-bastionhost-hub-cit"
$bastionPipAllocationMethod = "Static"
$bastionPipSku = "Standard"

$logAnalyticsName =  "law-hub-cit-01"
$bastionDiagnosticsName = "diag-bastionhost-hub-cit"
